...
// loader.objLoad('./elphant/index.obj', (meshes)=>{
  ...
  //     let count=0;
      meshes.forEach(({v, vn, vt, ind, g}, index)=>{
        ...
        // console.log(mesh)
        mesh._material = new DDD.UIColorMaterial({
          uColor: new DDD.Color(1,1,1,1)
        })


        // if(g=="Elephant1:desierfx_me_00 group3 group2_1") { // meimao
        // if(g=="group3 group2 Elephant1:desierfx_me_01_1") { // meimao
        // if(g=="group3 group2 Elephant1:desierfx_me_02_1") { // quanshen
        // if(g=="group3 group2 Elephant1:desierfx_me_03_1") { // ya + yan
          pare.add(mesh)
        // }
